#!/usr/bin/env bash
# =============================================================================
# POC Cluster Setup — asnStripe-westus2
# Subscription: Azure Network Agent - Runners (9bd7ff15-396a-4478-a89b-4d8ae7e302b6)
# Region: westus2
...
# === Configuration ===
SUBSCRIPTION="9bd7ff15-396a-4478-a89b-4d8ae7e302b6"
REGION="westus2"
PREFIX="asnStripe"
RG="${PREFIX}-${REGION}"
...
SUBNET_GW="10.1.1.1"
CP_IP="10.1.1.4"
WORKER_IPS=("10.1.1.5" "10.1.1.6" "10.1.1.7")
...
# Apply fix on each worker with their specific IPs
for i in 0 1 2; do
  WORKER_NUM=$(printf "%02d" $((i + 1)))
  ...
  # Get secondary IPs assigned to this NIC
